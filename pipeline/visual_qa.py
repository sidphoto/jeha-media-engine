...
PRODUCT_CUES = {
    ...
    "moon_room": ["moonlight", "rain night", "sleep", "low contrast"],
    "cozy_room": ["warm reading", "cafe", "fireplace", "intimate calm"],
...
def evaluate_visual_qa(assessment: dict) -> dict:
    """Apply JEHA Visual QA v1 weighted scoring and hard-fail rules.

    Input component values are normalized 0-100 observations produced by a reviewer or
    future vision model. Hard-fail flags are explicit booleans and always override score.
    """
...
def visual_policy(product: str) -> dict:
    ...
    return {
        ...
        "final_output": "AI-generated 16:9 master by default",
    }
